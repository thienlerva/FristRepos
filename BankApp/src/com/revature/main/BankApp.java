...
public class BankApp {
	...
	public static void listOfAccounts() {
		...
		int id;
			if(numOfAccount==1) {  // User has only 1 account
				...
				System.out.println("These are a list of your accounts: \n");
				for(int i = 0; i < listAccounts.size(); i++) {
					
					id = listAccounts.get(i).getTypeId();
					balance = listAccounts.get(i).getBalance();
					findAccountType(id);
					accountType = currentType.getAccounType();
	...
	public static void selectAccount() {
		...
		try {
			...
			System.out.println("Please select your account to begin with: ");
	...
	public static void registerAccount() {
		...
		boolean existUser = uService.checkUserNameExist(username);
